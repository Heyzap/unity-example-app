...
namespace FyberPlugin
{
  ...
  public partial class User
  {
    ...
    static public void SetGdprConsent(Boolean gdprConsent) {
      Put(GDPR_CONSENT, gdprConsent);
    }

    static public void SetGdprConsentData(Dictionary<string, string> gdprConsentData)
    {
      Dictionary<string, string> validatedGdprConsentData = null;
      if (gdprConsentData != null)
      {
        validatedGdprConsentData = new Dictionary<string, string>();
      ...
      Put(GDPR_CONSENT_DATA, validatedGdprConsentData);
    }
    ...
    static private string GeneratePutJsonString(string key, object value)
    {
      ...
      if (value != null)
      {
        ...
        {
          valueToInsert = ((DateTime)value).ToString("yyyy/MM/dd");
        }
        else
        {
          valueToInsert = value;
      ...
      dictionary.Add("value", valueToInsert);                         
