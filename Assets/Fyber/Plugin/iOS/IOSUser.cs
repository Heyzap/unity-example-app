...
namespace FyberPlugin
{
  ...
  public partial class User
  {
    ...
    [DllImport ("__Internal")]
    public static extern void _ClearGDPRConsentData();
    ...
    static public Boolean? GetGDPRConsent() {
      return (Boolean?)Get<Object>(GDPR_CONSENT);
    }
    ...
    static protected void NativeClearGdprConsentData()
    {      
      _ClearGDPRConsentData();
    }
